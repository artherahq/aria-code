...

    {
      "servers": [
        ...
        },
        {
          ...
          "enabled": false,
          "description": "Approved Apify web research Actors (enable only after token and data-use review)"
        }
      ]
    }
        ...
        example = {
            "servers": [
                ...
                },
                {
                    ...
                    "env": {"APIFY_TOKEN": "${APIFY_TOKEN}"},
                    "enabled": False,
                    "description": "Apify web research (review Actor terms and enable explicitly)"
                }
            ]
        }
