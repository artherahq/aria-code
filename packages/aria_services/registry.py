...
def list_service_specs() -> List[ServiceSpec]:
    ...
    return [
        ...
        ServiceSpec(
            name="brokers",
            description="Read-only broker account, positions, orders, and guarded trade execution adapters.",
            owner_package="brokers",
            module="brokers",
            capabilities=["broker.account", "broker.positions", "broker.orders", "broker.audit"],
