...
def list_service_specs() -> List[ServiceSpec]:
    ...
    return [
        ...
        ServiceSpec(
            ...
            description="Deterministic report completion, plausibility, coverage, and provenance gates.",
            owner_package="packages.aria_services",
            module="packages.aria_services.research_quality",
            capabilities=["report.quality_gate", "report.provenance", "report.plausibility"],
            permissions=[PermissionLevel.READ_ONLY],
            migration_target="ReportQualityAssessment",
        ),
        ServiceSpec(
            name="brokers",
        ...
        ServiceSpec(
            ...
            capabilities=[
                "skill.registry",
                "skill.discovery",
                "skill.metadata_route",
                "skill.namespace",
                "skill.integrity",
                "skill.activation_trace",
                "workflow.binding",
            ],
            permissions=[PermissionLevel.READ_ONLY],
