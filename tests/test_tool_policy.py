...
def test_add_to_allowlist(tmp_policy_file):
    from aria_code.runtime.tool_policy import add_to_policy, check_tool_policy
...
def test_moving_between_lists(tmp_policy_file):
    ...
    from aria_code.runtime.tool_policy import load_tool_policy
    policy = load_tool_policy()
    assert "edit_file" not in policy["allowed"]


def test_remove_from_policy(tmp_policy_file):
    from aria_code.runtime.tool_policy import add_to_policy, remove_from_policy, check_tool_policy
...
def test_remove_nonexistent_returns_false(tmp_policy_file):
    from aria_code.runtime.tool_policy import remove_from_policy
    assert remove_from_policy("nonexistent_tool") is False


def test_policy_persists_to_disk(tmp_policy_file):
    from aria_code.runtime.tool_policy import add_to_policy, load_tool_policy
