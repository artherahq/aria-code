...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/协议-BSL%201.1-f59e0b?style=for-the-badge" alt="license"/>
...
<p align="center">
  <b>通用 AI 产品审核与编程智能体</b><br>
  <sub>审核产品 · 理解代码仓库 · 编写并验证代码 · 金融能力作为可选扩展</sub>
</p>
...
Aria Code 是一款**终端优先的通用产品与软件工程智能体**。它可以审核用户上传的产品、理解现有代码仓库、发现正确性与安全风险、规划改进、实现功能并验证代码。金融与量化研究继续保留，但作为按需启用的领域能力，不再定义默认体验。
...
个人、内部、教学、研究用途（包括用自己的账户做交易决策）可**免费**使用、运行、
修改、自托管。若要把 Aria Code 作为托管/SaaS 服务对外提供，或销售基于它的竞品，
需购买商业许可（联系 dev@arthera.finance）。每个版本在发布 4 年后自动转为 Apache 2.0。

> **4.1.2 及之前**的版本以 MIT 发布，仍按 MIT 条款提供。
