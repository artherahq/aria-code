...
CODING_SYSTEM_PROMPT = (
    ...
    "1. If creating a new script: call write_file with a complete self-contained script in ./generated/<descriptive_name>.py.\n"
    "   If editing an existing script: call read_file on that specific file first, then improve with edit_file.\n"
    ...
    "4. Verify: run the script to confirm output files were generated.\n"
